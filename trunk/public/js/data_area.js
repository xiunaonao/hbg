var _Addr={
    ...
    city:function(key){
        ...
        var list=Object.keys(__DATA[key]);
        return list;

    },
    area:function(key,key2){
        if(!key){
            key='北京市';
        }
        if(!key2){
        ...
        var list=__DATA[key][key2];
        return list;
    },
    bind:function(select1,select2,select3,key1,key2,key3){
        var t=this;
        var dom1=document.querySelector(select1);
        var dom2=document.querySelector(select2);
        var dom3=document.querySelector(select3);

        t.write(dom1,this.province());
        if(key1){
            dom1.value=key1;
            t.write(dom2,this.city(key1));
        }else{
            t.write(dom2,this.city());
        }
        if(key2){
            dom2.value=key2;
            t.write(dom3,this.area(key1,key2));
        }else{
            t.write(dom3,this.area());
        }
        ...
        dom1.addEventListener('change',function(e){
            var key=this.value;
            var citys=t.city(key);
            t.write(dom2,citys);
            t.write(dom3,t.area(key,citys[0]));
        });

        dom2.addEventListener('change',function(e){
            var key=dom1.value;
            var key2=this.value;
            var areas=t.area(key,key2);
            t.write(dom3,areas);
        });
    },
    write(dom,list){
...
var __DATA = {
    ...
    '内蒙古自治区': {
        ...
        '兴安市': ['乌兰浩特市', '阿尔山市', '科尔沁右翼前旗', '科尔沁右翼中旗', '扎赉特旗', '突泉县', '其他'],
        '锡林郭勒市': ['二连浩特市', '锡林浩特市', '阿巴嘎旗', '苏尼特左旗', '苏尼特右旗', '东乌珠穆沁旗', '西乌珠穆沁旗', '太仆寺旗', '镶黄旗', '正镶白旗', '正蓝旗', '多伦县', '其他'],
        '阿拉善市': ['阿拉善左旗', '阿拉善右旗', '额济纳旗', '其他']
    },
    '辽宁省': {
    ...
    '云南省': {
        ...
        '楚雄市': ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰县', '其他'],
        '红河市': ['个旧市', '开远市', '蒙自县', '屏边苗族自治县', '建水县', '石屏县', '弥勒县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县', '其他'],
        '文山市': ['文山县', '砚山县', '西畴县', '麻栗坡县', '马关县', '丘北县', '广南县', '富宁县', '其他'],
        '西双版纳市': ['景洪市', '勐海县', '勐腊县', '其他'],
        '大理市': ['大理市', '漾濞彝族自治县', '祥云县', '宾川县', '弥渡县', '南涧彝族自治县', '巍山彝族回族自治县', '永平县', '云龙县', '洱源县', '剑川县', '鹤庆县', '其他'],
        '德宏市': ['瑞丽市', '潞西市', '梁河县', '盈江县', '陇川县', '其他'],
        '怒江市': ['泸水县', '福贡县', '贡山独龙族怒族自治县', '兰坪白族普米族自治县', '其他'],
        '迪庆市': ['香格里拉县', '德钦县', '维西傈僳族自治县', '其他']
    },
    '西藏自治区': {
        ...
        '阿里市': ['普兰县', '札达县', '噶尔县', '日土县', '革吉县', '改则县', '措勤县', '其他'],
    ...
    '甘肃省': {
        ...
        '临夏市': ['临夏市', '临夏县', '康乐县', '永靖县', '广河县', '和政县', '东乡族自治县', '积石山保安族东乡族撒拉族自治县', '其他'],
        '甘南市': ['合作市', '临潭县', '卓尼县', '舟曲县', '迭部县', '玛曲县', '碌曲县', '夏河县', '其他']
    },
    '青海省': {
        '西宁市': ['城东区', '城中区', '城西区', '城北区', '大通回族土族自治县', '湟中县', '湟源县', '其他'],
        '海东市': ['平安县', '民和回族土族自治县', '乐都县', '互助土族自治县', '化隆回族自治县', '循化撒拉族自治县', '其他'],
        '海北市': ['门源回族自治县', '祁连县', '海晏县', '刚察县', '其他'],
        '黄南市': ['同仁县', '尖扎县', '泽库县', '河南蒙古族自治县', '其他'],
        '海南市': ['共和县', '同德县', '贵德县', '兴海县', '贵南县', '其他'],
        '果洛市': ['玛沁县', '班玛县', '甘德县', '达日县', '久治县', '玛多县', '其他'],
        '玉树市': ['玉树县', '杂多县', '称多县', '治多县', '囊谦县', '曲麻莱县', '其他'],
        '梅西市': ['格尔木市', '德令哈市', '乌兰县', '都兰县', '天峻县', '其他']
    },
    '宁夏回族自治区': {
    ...
    '新疆维吾尔自治区': {
        ...
        '昌吉市': ['昌吉市', '阜康市', '呼图壁县', '玛纳斯县', '奇台县', '吉木萨尔县', '木垒哈萨克自治县', '其他'],
        '博尔塔拉市': ['博乐市', '精河县', '温泉县', '其他'],
        '巴音郭楞市': ['库尔勒市', '轮台县', '尉犁县', '若羌县', '且末县', '焉耆回族自治县', '和静县', '和硕县', '博湖县', '其他'],
        '阿克苏市': ['阿克苏市', '温宿县', '库车县', '沙雅县', '新和县', '拜城县', '乌什县', '阿瓦提县', '柯坪县', '其他'],
        '克孜勒苏市': ['阿图什市', '阿克陶县', '阿合奇县', '乌恰县', '其他'],
        '喀什市': ['喀什市', '疏附县', '疏勒县', '英吉沙县', '泽普县', '莎车县', '叶城县', '麦盖提县', '岳普湖县', '伽师县', '巴楚县', '塔什库尔干县塔吉克自治', '其他'],
        '和田市': ['和田市', '和田县', '墨玉县', '皮山县', '洛浦县', '策勒县', '于田县', '民丰县', '其他'],
        '伊犁市': ['伊宁市', '奎屯市', '伊宁县', '察布查尔锡伯自治县', '霍城县', '巩留县', '新源县', '昭苏县', '特克斯县', '尼勒克县', '其他'],
        '塔城市': ['塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县', '和布克赛尔蒙古自治县', '其他'],
        '阿勒泰市': ['阿勒泰市', '布尔津县', '富蕴县', '福海县', '哈巴河县', '青河县', '吉木乃县', '其他'],
        '石河子市': ['新城街道', '向阳街道', '红山街道', '老街街道', '东城街道', '北泉镇', '石河子乡', '兵团一五二团', '其他'],
        '阿拉尔市': ['金银川路街道', '幸福路街道', '青松路街道', '南口街道', '托喀依乡工业园区', '兵团七团', '兵团八团', '兵团十团', '兵团十一团', '兵团十二团', '兵团十三团', '兵团十四团', '兵团十六团', '兵团第一师水利水电工程处', '兵团第一师塔里木灌区水利管理处', '阿拉尔农场', '兵团第一师幸福农场', '中心监狱', '其他'],
        '图木舒克市': ['齐干却勒街道', '前海街道', '永安坝街道', '兵团四十四团', '兵团四十九团', '兵团五十团', '兵团五十一团', '兵团五十三团', '兵团图木舒克市喀拉拜勒镇', '兵团图木舒克市永安坝', '其他'],
        '五家渠市': ['军垦路街道', '青湖路街道', '人民路街道', '兵团一零一团', '兵团一零二团', '兵团一零三团', '其他']
    }
};
/*
    '香港': {
        '香港市': ['中西区', '东区', '九龙城区', '观塘区', '南区', '深水区', '湾仔区', '黄大仙区', '油尖旺区', '离岛区', '葵青区', '北区', '西贡区', '沙田区', '屯门区', '大埔区', '荃湾区', '元朗区', '其他']
    },
    '澳门': {
        '澳门市': ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区', '嘉模堂区', '圣方济各堂区', '其他']
    },
    '台湾': {
        '台湾市': ['台北市', '高雄市', '基隆市', '台中市', '台南市', '新竹市', '嘉义市', '台北县', '宜兰县', '新竹县', '桃园县', '苗栗县', '台中县', '彰化县', '南投县', '嘉义县', '云林县', '台南县', '高雄县', '屏东县', '台东县', '花莲县', '澎湖县', '其他']
    }
};
*/